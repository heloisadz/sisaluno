...
if(isset($_GET['cadastrar'])){
        ...
        ##codigo SQL
        $sql = "INSERT INTO aluno(nome,endereco,idade, datanascimento,statusaluno,matricula) 
                VALUES('$nomealuno','$enderecoaluno',$idadealuno,'$dataaluno','$statusaluno','$matriculaaluno')";
...
if(isset($_POST['update'])){
    ...
    $matricula = $_POST["matricula"];
      ...
      ##codigo sql
    $sql = "UPDATE  aluno SET nome= :nome, idade= :idade, endereco= :endereco, datanascimento= :datanascimento,statusaluno= :statusaluno, matricula= :matricula WHERE id= :id ";
